...
const ButtonModel = {
  ...
  danger:
    "bg-rose-500 hover:bg-rose-600 rounded font-medium text-white px-6 py-2",
  warning:
    "bg-amber-500 hover:bg-amber-600 rounded font-medium text-white px-6 py-2",
  dark: "bg-zinc-500 hover:bg-zinc-600 rounded font-medium text-white px-6 py-2",
  success:
    "bg-green-400 hover:bg-green-500 rounded font-medium text-white px-6 py-2",
  ...
  if (loading)
    return (
      <button disabled className="text-gray-400">
        <i className="fa fa-spinner fa-spin mr-2">proccessing..</i>
      </button>
    );
